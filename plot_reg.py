...
def plot_regularization_results(results):
    """
    Plot training and validation metrics for different regularization settings.
    
    Args:
        results (dict): Dictionary containing training history for each regularization setting
    """
